...
<div class="space-y-6">
    ...
    <div class="glass-card overflow-x-auto">
        <table class="data-table">
            <thead><tr><th>Trader</th><th>Amount</th><th>Min. Investment</th><th>P&amp;L</th><th>Status</th><th></th></tr></thead>
            <tbody>
                @forelse ($allocations as $a)
                    <tr>
                        ...
                        <td class="font-numeric text-text-muted">${{ number_format($a->minimum_amount, 2) }}</td>
                ...
                @empty
                    <tr><td colspan="6" class="text-center text-text-muted">You are not copying any traders yet.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
