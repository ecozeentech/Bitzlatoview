...
<div class="space-y-6">
    ...
    <div class="glass-card p-5">
        ...
        <div class="overflow-x-auto">
            ...
            <thead><tr><th>Year</th><th>Method</th><th>Income</th><th>Fees</th><th>Tax Rate</th><th>Est. Tax Owed</th><th>Generated</th><th></th></tr></thead>
            <tbody>
                @forelse ($reports as $r)
                    <tr>
                        ...
                        <td class="font-numeric text-text-muted">{{ $r->tax_rate_pct !== null ? number_format($r->tax_rate_pct, 2).'%' : 'Pending admin review' }}</td>
                        <td class="font-numeric text-text-muted">{{ $r->estimated_tax_owed !== null ? number_format($r->estimated_tax_owed, 2) : 'Pending admin review' }}</td>
                ...
                @empty
                    <tr><td colspan="8" class="text-center text-text-muted">No reports generated yet.</td></tr>
                @endforelse
            </tbody>
        </table>
        </div>
