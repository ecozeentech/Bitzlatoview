...
<title>{{ $title ?? 'Bitzlatoview' }} — Bitzlatoview</title>
<meta name="description" content="{{ $description ?? 'Bitzlatoview — trade crypto, stocks, forex, futures, NFTs and more from one modern exchange dashboard. Simulation/paper-trading mode.' }}">
<link rel="icon" href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><rect width=%22100%22 height=%22100%22 rx=%2220%22 fill=%22%23070A12%22/><text x=%2250%25%22 y=%2258%25%22 font-size=%2250%22 text-anchor=%22middle%22 fill=%22%23F5B301%22 font-family=%22Arial%22 font-weight=%22bold%22>B</text></svg>">
