...
<div class="page-shell py-16">
  ...
  <h1 class="section-title mt-2">About</h1>
  <p class="section-sub">Bitzlatoview is a multi-asset trading platform MVP built for compliance-aware simulation first.</p>
