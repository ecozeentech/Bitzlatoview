...
@section('title', 'AI Trading Bots')
@section('content')

<div class="page-shell py-16">
  <p class="text-xs uppercase tracking-[0.2em] text-brand">Bitzlatoview</p>
  <h1 class="section-title mt-2">AI Trading Bots</h1>
  <p class="section-sub">Allocate from Investment Wallet to experimental strategies. May lose money.</p>
