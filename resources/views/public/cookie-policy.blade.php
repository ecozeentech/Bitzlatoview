...
<div class="page-shell py-16">
  ...
  <h1 class="section-title mt-2">Cookie Policy</h1>
  <p class="section-sub">We use essential cookies for sessions and security. Configure consent tooling as needed.</p>
