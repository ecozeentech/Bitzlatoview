...
<div class="page-shell py-16">
  ...
  <h1 class="section-title mt-2">NFT Marketplace</h1>
  <p class="section-sub">Browse collections, floor prices, and connect external wallets via WalletConnect placeholder.</p>
