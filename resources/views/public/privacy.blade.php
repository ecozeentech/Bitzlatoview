...
<div class="page-shell py-16">
  ...
  <h1 class="section-title mt-2">Privacy Policy</h1>
  <p class="section-sub">How we handle account, KYC, and transaction data. Replace with counsel-approved policy.</p>
