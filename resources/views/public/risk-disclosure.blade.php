...
<div class="page-shell py-16">
  ...
  <h1 class="section-title mt-2">Risk Disclosure</h1>
  <p class="section-sub">Trading crypto, stocks, forex, futures, bots, mining, and P2P can result in loss of capital.</p>
